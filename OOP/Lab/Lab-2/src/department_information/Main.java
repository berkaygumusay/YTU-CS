...
public class Main {
	...
	Administrative_Staff administrative_staff = new Administrative_Staff(1,"Sırma YAVUZ","www.sirmayavuz.com");
	...
	Academic_Staff staff1 = new Academic_Staff(1, "İdris DEMİR", "www.idrisdemir.com", "idrisd@yildiz.edu.tr", "D-025");
	...
	administrative_staff.add_staff_to_commission(d, 0, "Assignment Commission");
	administrative_staff.add_staff_to_commission(d, 1, "Internship Commission");
	administrative_staff.add_staff_to_commission(d, 2, "Assignment Commission");
